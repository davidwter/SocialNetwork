...
goog.DEPENDENCIES_ENABLED && (goog.dependencies_ = {
    ...
    if (goog.isDef(goog.global.CLOSURE_BASE_PATH))
        ...
        for (var a = goog.global.document.getElementsByTagName("SCRIPT"), b = a.length - 1; 0 <= b; --b) {
            var c = a[b].src, d = c.lastIndexOf("?"), d =- 1 ==
            d ? c.length : d;
...
function(a, b) {
    if (goog.inHtmlDocument_()) {
        ...
        void 0 === b ? d ? (d = " onreadystatechange='goog.onScriptLoad_(this, " + ++goog.lastNonModuleScriptIndex_ + ")' ", c.write('<script type="text/javascript" src="' + a + '"' + d + ">\x3c/script>")) : goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING ? goog.appendScriptSrcNode_(a) :
        goog.writeScriptSrcNode_(a) : c.write('<script type="text/javascript">' + b + "\x3c/script>");
        return !0
    }
    return !1
...
goog.ui.tree.BaseNode.prototype.setExpanded = function(a) {
    ...
    if (!b || this.dispatchEvent(a ? goog.ui.tree.BaseNode.EventType.BEFORE_EXPAND : goog.ui.tree.BaseNode.EventType.BEFORE_COLLAPSE)) {
        ...
        } else (c = this.getChildrenElement()
...
Blockly.Icon.prototype.computeIconLocation = function() {
    var a = this.block_.getRelativeToSurfaceXY(), b = Blockly.getRelativeXY_(this.iconGroup_), c = a.x + b.x + this.SIZE / 2, a = a.y + b.y + this.SIZE / 2;
...
Blockly.Connection.prototype.connect = function(a) {
    ...
    if (this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE) {
        ...
        if (a.targetConnection) {
            ...
            c.setParent(null);
            if (c.isShadow())
                a.setShadowDom(Blockly.Xml.blockToDom_(c)), c.dispose();
            else {
...
Blockly.Connection.prototype.closest = function(a, b, c) {
    function d(b) {
        b = e[b];
        if ((b.type == Blockly.OUTPUT_VALUE || b.type == Blockly.PREVIOUS_STATEMENT) && b.targetConnection || b.type == Blockly.INPUT_VALUE && b.targetConnection&&!b.targetBlock().isMovable()&&!b.targetBlock().isShadow() ||!q.checkType_(b))
            return !0;
        ...
        while (c);
        var d = f - b.x_, c = g - b.y_, d = Math.sqrt(d * d + c * c);
        d <= a && (k = b, a = d);
        return Math.abs(c) < a
    }
    if (this.targetConnection)
    ...
    var e = this.dbOpposite_, f = this.x_ + b, g = this.y_ + c;
    b = 0;
...
Blockly.Connection.prototype.checkType_ = function(a) {
    ...
    if (b&&!b.isMovable()&&!this.sourceBlock_.isMovable() || (b = a.targetBlock())&&!b.isMovable()&&!a.sourceBlock_.isMovable())
        return !1;
...
Blockly.Connection.prototype.neighbours_ = function(a) {
    ...
    for (var c = this.dbOpposite_, d = this.x_, e = this.y_, f = 0, g = c.length - 2, h = g; f < h;)
...
Blockly.Field.prototype.onMouseUp_ = function(a) {
    if (!goog.userAgent.IPHONE&&!goog.userAgent.IPAD || goog.userAgent.isVersionOrHigher("537.51.2") || 0 === a.layerX || 0 === a.layerY)
        Blockly.isRightButton(a) || 2 != Blockly.dragMode_ && this.sourceBlock_.isEditable() && this.showEditor_()
};
...
Blockly.Scrollbar.prototype.onMouseDownBar_ = function(a) {
    ...
    if (!Blockly.isRightButton(a)) {
        var b = Blockly.mouseToSvg(a, this.workspace_.options.svg), b = this.horizontal_ ? b.x: b.y, c = Blockly.getSvgXY_(this.svgKnob_, this.workspace_), c = this.horizontal_ ? c.x: c.y, d = parseFloat(this.svgKnob_.getAttribute(this.horizontal_ ? "width" : "height")), e = parseFloat(this.svgKnob_.getAttribute(this.horizontal_ ? "x" : "y")), f = .95 * d;
        b <= c ? e -= f : b >= c + d && (e += f);
...
Blockly.Trashcan.prototype.createDom = function() {
    ...
    var a = String(Math.random()).substring(2), b = Blockly.createSvgElement("clipPath", {
...
Blockly.ZoomControls.prototype.createDom = function() {
    ...
    var b = String(Math.random()).substring(2), c = Blockly.createSvgElement("clipPath", {
...
Blockly.Xml.blockToDom_ = function(a) {
    ...
    if (c = a.getNextBlock())
        h =
        goog.dom.createDom("next", null, Blockly.Xml.blockToDom_(c)), b.appendChild(h);
...
Blockly.Xml.domToWorkspace = function(a, b) {
    ...
    for (var d = b.childNodes.length, e = 0; e < d; e++) {
        ...
        if ("block" == f.nodeName.toLowerCase()) {
            var g = Blockly.Xml.domToBlock(a, f), h = parseInt(f.getAttribute("x"), 10), f = parseInt(f.getAttribute("y"), 10);
...
Blockly.Xml.domToBlockHeadless_ = function(a, b, c) {
    ...
    if (c && f) {
        ...
        if (!d)
            throw "Couldn't get Block with id: " + f;
        f = d.getParent();
        d.workspace && d.dispose(!0, !1, !0);
        d.fill(a, e);
        d.parent_ = f
    } else 
        d = Blockly.Block.obtain(a, e);
    for (var g = null, f = 0, h; h = b.childNodes[f]; f++)
        if (3 != h.nodeType) {
            for (var k = g = null, l = 0, q; q = h.childNodes[l]; l++)
                1 == q.nodeType && ("block" == q.nodeName.toLowerCase() ?
                ...
                case "statement":
                    ...
                    if (g)
                        if (g = Blockly.Xml.domToBlockHeadless_(a, g, c), g.outputConnection)
...
Blockly.WorkspaceSvg.prototype.isDeleteArea = function(a) {
    ...
    if (this.deleteAreaTrash_) {
        if (this.deleteAreaTrash_.contains(a))
            return this.trashcan.setOpen_(!0), Blockly.Css.setCursor(Blockly.Css.Cursor.DELETE), !0;
...
Blockly.WorkspaceSvg.prototype.onMouseWheel_ = function(a) {
    Blockly.terminateDrag_();
    var b = 0 < a.deltaY?-1 : 1, c = Blockly.mouseToSvg(a, this.options.svg);
    this.zoom(c.x, c.y, b);
    a.preventDefault()
};
    ...
    if (!this.options.readOnly) {
        ...
        if (this.options.collapse) {
            for (var e = d=!1, f = 0; f < c.length; f++)
                for (var g = c[f]; g;)
                    g.isCollapsed() ? d=!0 : e=!0, g = g.getNextBlock();
            var h = function(a) {
                for (var b = 0, d = 0; d < c.length; d++)
                    for (var e = c[d]; e;)
                        setTimeout(e.setCollapsed.bind(e, a), b), e = e.getNextBlock(), b += 10
            }, e = {
                enabled: e
            };
...
Blockly.WorkspaceSvg.prototype.removeChangeListener = function(a) {
    ...
    a = this.eventWrappers_.indexOf(a);
    - 1 != a && this.eventWrappers_.splice(a, 1)
};
...
Blockly.WorkspaceSvg.prototype.zoom = function(a, b, c) {
    var d = this.options.zoomOptions.scaleSpeed, e = this.getMetrics(), f = this.options.svg.createSVGPoint();
    f.x = a;
    f.y = b;
    ...
    this.scale !=
    a.a && (this.scale = a.a, this.scrollX = a.e - e.absoluteLeft, this.scrollY = a.f - e.absoluteTop, this.updateGridPattern_(), this.scrollbar.resize(), Blockly.hideChaff(!1), this.flyout_ && this.flyout_.reflow())
};
...
Blockly.WorkspaceSvg.prototype.zoomReset = function(a) {
    ...
    this.scrollbar && this.scrollbar.resize();
    var b = this.getMetrics();
    this.scrollbar.set((b.contentWidth - b.viewWidth) / 2, (b.contentHeight - b.viewHeight) / 2);
    a.stopPropagation()
};
...
Blockly.Mutator.prototype.resizeBubble_ = function() {
    var a = 2 * Blockly.Bubble.BORDER_WIDTH, b = this.workspace_.getCanvas().getBBox(), c = this.workspace_.flyout_.getMetrics_(), d;
    ...
    if (Math.abs(this.workspaceWidth_ - d) > a || Math.abs(this.workspaceHeight_ - b) > a)
        this.workspaceWidth_ = d, this.workspaceHeight_ = b, this.bubble_.setBubbleSize(d + a, b + a), this.svgDialog_.setAttribute("width", this.workspaceWidth_), this.svgDialog_.setAttribute("height",
...
Blockly.Mutator.prototype.setVisible = function(a) {
    if (a != this.isVisible())
        if (a) {
            ...
            this.svgDialog_ = null, this.workspace_.dispose(), this.rootBlock_ = this.workspace_ = null, this.bubble_.dispose(), this.bubble_ = null, this.workspaceHeight_ = this.workspaceWidth_ = 0, this.sourceListener_ && (Blockly.unbindEvent_(this.sourceListener_), this.sourceListener_ = null)
};
...
Blockly.Block.obtain = function(a, b) {
    if (Blockly.Realtime.isEnabled())
        return Blockly.Realtime.obtainBlock(a, b);
...
Blockly.Block.prototype.setParent = function(a) {
    if (this.parentBlock_) {
        ...
        goog.array.contains(this.workspace.getTopBlocks(!1), this) && this.workspace.removeTopBlock(this);
    (this.parentBlock_ =
...
Blockly.BlockSvg.prototype.onMouseUp_ = function(a) {
    ...
    Blockly.doCommand(function() {
        ...
        if (Blockly.selected && Blockly.highlightedConnection_)
            Blockly.localConnection_.connect(Blockly.highlightedConnection_), b.rendered && (Blockly.localConnection_.isSuperior() ? Blockly.highlightedConnection_ : Blockly.localConnection_).sourceBlock_.connectionUiEffect(), b.workspace.trashcan && b.workspace.trashcan.close();
...
Blockly.BlockSvg.prototype.onMouseMove_ = function(a) {
    ...
    Blockly.doCommand(function() {
        if (!("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button)) {
            Blockly.removeAllRanges();
            var d = b.getRelativeToSurfaceXY(), e = c.moveDrag(a), f = b.getSvgRoot();
...
Blockly.BlockSvg.prototype.setEditable = function(a) {
    ...
    if (this.rendered)
        for (a = 0; a < this.icons_.length; a++)
            this.icons_[a].updateEditable()
};
...
Blockly.BlockSvg.prototype.dispose = function(a, b, c) {
    ...
    goog.dom.removeNode(this.svgGroup_);
    this.svgPathDark_ =
    this.svgPathLight_ = this.svgPath_ = this.svgGroup_ = null;
    Blockly.Field.stopCache()
};
...
Blockly.BlockSvg.prototype.updateColour = function() {
    if (!this.disabled) {
        var a = Blockly.makeColour(this.getColour()), b = goog.color.hexToRgb(a);
        if (this.isShadow())
...
Blockly.BlockSvg.prototype.renderDraw_ = function(a, b) {
    ...
    if (this.outputConnection)
        ...
        if (this.previousConnection) {
            ...
            Blockly.BlockSvg.START_HAT && (this.startHat_ = this.squareTopLeftCorner_=!0, b.rightEdge = Math.max(b.rightEdge, 100));
        this.getNextBlock() && (this.squareBottomLeftCorner_ =
        !0)
    }
...
Blockly.FieldTextInput.prototype.showEditor_ = function(a) {
    ...
    if (!b && (goog.userAgent.MOBILE || goog.userAgent.ANDROID || goog.userAgent.IPAD))
        a = window.prompt(Blockly.Msg.CHANGE_VALUE_TITLE, this.text_), this.sourceBlock_ && this.changeHandler_ && (b = this.changeHandler_(a), void 0 !== b && (a = b)), null !== a && this.setText(a);
    else {
...
Blockly.FieldAngle.prototype.setChangeHandler = function(a) {
    Blockly.FieldAngle.superClass_.setChangeHandler.call(this, a ? function(b) {
        ...
        if (null === c)
            ...
            void 0 === c && (c = b), d = Blockly.FieldAngle.angleValidator.call(this, c), void 0 !== d && (d = c);
        return d === b ? void 0 : d
...
Blockly.FieldAngle.prototype.updateGraph_ = function() {
    if (this.gauge_) {
        ...
        if (isNaN(a))
            this.gauge_.setAttribute("d", "M " + Blockly.FieldAngle.HALF + "," + Blockly.FieldAngle.HALF), this.line_.setAttribute("x2", Blockly.FieldAngle.HALF), this.line_.setAttribute("y2", Blockly.FieldAngle.HALF);
        else {
...
Blockly.Variables.renameVariable = function(a, b, c) {
    c = c.getAllBlocks();
    for (var d = 0; d < c.length; d++)
        c[d].renameVar && c[d].renameVar(a, b)
};
...
Blockly.FieldVariable.prototype.setChangeHandler = function(a) {
    Blockly.FieldVariable.superClass_.setChangeHandler.call(this, a ? function(b) {
        ...
        if (null === c)
            ...
            void 0 === c && (c = b), d = Blockly.FieldVariable.dropdownChange.call(this, c), void 0 !== d && (d = c);
        return d === b ? void 0 : d
...
Blockly.Generator.prototype.blockToCode = function(a) {
    ...
    if (goog.isString(b))
        return this.STATEMENT_PREFIX && (b = this.STATEMENT_PREFIX.replace(/%1/g, "'" + a.id + "'") + b), this.scrub_(a, b);
    if (null === b)
        return "";
...
Blockly.Procedures.flyoutCategory = function(a, b, c, d) {
    function e(e, f) {
        for (var k = 0; k < e.length; k++) {
            ...
            for (var q = [], m = 0; m < e[k][1].length; m++)
                q[m] = "ARG" + m;
...
Blockly.Flyout.prototype.init = function(a) {
    ...
    Array.prototype.push.apply(this.eventWrappers_, Blockly.bindEvent_(this.targetWorkspace_.getCanvas(), "blocklyWorkspaceChange", this, this.filterForCapacity_));
...
Blockly.Flyout.prototype.show = function(a) {
    ...
    for (var c = 0, e; e = this.buttons_[c]; c++)
    ...
    if (a == Blockly.Variables.NAME_TYPE)
        ...
        for (var h = 0; d = a[h]; h++)
            d.tagName && "BLOCK" == d.tagName.toUpperCase() && (d = Blockly.Xml.domToBlock(this.workspace_, d), b.push(d), g.push(3 * f));
    a = f;
    for (h = 0; d = b[h]; h++) {
        c = d.getDescendants();
        e = 0;
        for (var k; k = c[e]; e++)
            k.isInFlyout=!0, k.setCommentText(null);
        d.render();
        k = d.getSvgRoot();
        e = d.getHeightWidth();
        c = this.RTL ? 0 : f / this.workspace_.scale + Blockly.BlockSvg.TAB_WIDTH;
        d.moveBy(c, a);
        a += e.height + g[h];
...
Blockly.Flyout.prototype.createBlockFunc_ = function(a) {
    ...
    return function(d) {
        if (!Blockly.isRightButton(d)&&!a.disabled) {
            var e = Blockly.Xml.blockToDom_(a), e = Blockly.Xml.domToBlock(c, e), f = a.getSvgRoot();
            if (!f)
            ...
            if (b.RTL) {
                ...
                f.x += b.workspace_.scrollX / b.workspace_.scale - b.workspace_.scrollX;
...
Blockly.Flyout.prototype.getRect = function() {
    var a = Blockly.mainWorkspace, b = Blockly.getSvgXY_(this.svgGroup_, a).x;
    this.RTL || (b -= 1E9);
...
Blockly.parseOptions_ = function(a) {
    ...
    if (b)
        ...
        c = Blockly.parseToolboxTree_(a.toolbox), d = Boolean(c && c.getElementsByTagName("category").length), e = a.trashcan, void 0 === e && (e = d), f = a.collapse, void 0 === f && (f = d), g = a.comments, void 0 === g && (g = d), h = a.disable, void 0 === h && (h = d), k = a.sounds, void 0 === k && (k=!0);
    var l = a.scrollbars;
    void 0 === l && (l = d);
    var q = a.css;
    void 0 === q && (q=!0);
    ...
    var n = a.zoom || {}, r = {};
    r.enabled = l&&!!n.enabled;
    r.enabled ? (r.controls = void 0 === n.controls?!0 : !!n.controls, r.wheel = void 0 === n.wheel?!0 : !!n.wheel, r.maxScale = void 0 === n.maxScale ? 3 : parseFloat(n.maxScale), r.minScale = void 0 === n.minScale ? .3 : parseFloat(n.minScale), r.scaleSpeed = void 0 === n.scaleSpeed ? 1.2 : parseFloat(n.scaleSpeed)) : (r.controls=!1, r.wheel =
    !1);
    n=!!a.realtime;
    return {
        RTL: !!a.rtl,
...
Blockly.createDom_ = function(a, b) {
    ...
    var c = Blockly.createSvgElement("svg", {
        ...
        version: "1.1",
        "class": "blocklySvg"
    }, a), d = Blockly.createSvgElement("defs", {}, c), e = String(Math.random()).substring(2), f = Blockly.createSvgElement("filter", {
...
Blockly.fireUiEventNow = function(a, b) {
    ...
    if (document.createEvent)
        c = document.createEvent("UIEvents"), c.initEvent(b, !0, !0), a.dispatchEvent(c);
...
Blockly.onKeyDown_ = function(a) {
    if (!Blockly.isTargetInput_(a)) {
        ...
        if (27 == a.keyCode)
            ...
            Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && (67 == a.keyCode ? (Blockly.hideChaff(), Blockly.copy_(Blockly.selected)) : 88 == a.keyCode && (Blockly.copy_(Blockly.selected), b=!0)), 86 == a.keyCode && Blockly.clipboardXml_ &&
...
Blockly.getMainWorkspaceMetrics_ = function() {
    ...
    var b = Blockly.Flyout.prototype.CORNER_RADIUS - 1, c = a.width - b, d = a.height - b;
    try {
        var e = this.getCanvas().getBBox()
    } catch (l) {
        return null
    }
    var f = e.width * this.scale, g = e.height * this.scale, h = e.x * this.scale, k = e.y * this.scale;
